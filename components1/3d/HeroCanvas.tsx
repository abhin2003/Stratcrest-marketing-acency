  ...
  return (
    <group key="premium-coin-v4" ref={meshRef} scale={0.18}>
      ...
      <mesh position={[0, 0, 1.35]}>
        ...
        <meshBasicMaterial map={texture} transparent={true} depthTest={true} />
      </mesh>
...
export default function HeroCanvas() {
  return (
    <div id="hero-3d-canvas" className="w-full h-full min-h-[500px] relative bg-transparent overflow-visible">
      <Canvas
